            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-black text-slate-950">
                  {user?.company_name || "Панел на Производител"}
                </h1>
                <p className="text-xs text-slate-500 mt-0.5">Управлявайте квотите, наличностите, ценоразписа и отстъпките за количество.</p>
              </div>
            </div>
